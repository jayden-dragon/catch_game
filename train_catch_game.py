...
class CatchEnvironment():
  ...
  # 관찰 결과를 리턴합니다.
  # Drawstate를 호출해서 생성된 관찰 결과를 리턴합니다.
  def observe(self):
  ...
  # 게임을 초기 상태로 리셋합니다.
  # 랜덤한 위치에 fruit 할당, bascket은 맨 아래줄 랜덤한 위체에 할당
  def reset(self): 
